...
#    Updated: 2023/01/30 13:33:52 by minsulee         ###   ########seoul.kr   #
#                                                                              #
# **************************************************************************** #
...
#	make -C get_next_line clean
	gcc -g3 -lreadline -L/Users/minsulee/.brew/opt/readline/lib -I/Users/minsulee/.brew/opt/readline/include libft/libft.a cd.c echo.c env_split.c env.c exit.c export.c minsu_test_tokenize.c pwd.c test.c unset.c vector.c heredoc.c
